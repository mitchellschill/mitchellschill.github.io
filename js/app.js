...
var InitDemo = function () {
	...
	gl.clearColor(0.1333, 0.1333, 0.1333, 1.0);
	...
	var loop = function () {
		...
		if(countDirection) scale = scale + 0.01;
		else scale = scale - 0.01;
		
		if(scale > 2) countDirection = 0
		if(scale < -2) countDirection = 1;
		/*
		if((scale > 3) || (scale < 0.5)){
				if (1==countDirection) countDirection = -1;
				if (-1==countDirection) countDirection = 1;
		}
*/		
